...
#+begin_src emacs-lisp :tangle (if (string-match "-[Mm]icrosoft" operating-system-release) init-file "no")
...
#+begin_src emacs-lisp :tangle (if (not (string-match "-[Mm]icrosoft" operating-system-release)) init-file "no")
...
#+begin_src emacs-lisp
  (defun ts-tangle-config ()
    ...
    (org-babel-tangle-file "~/src/github/tslight/emacs/README.org"))
#+end_src
...
#+begin_src emacs-lisp :tangle (if (version< emacs-version "28") "no" init-file)
  (setq ts-project-roots '("~" "~/src/github"))
...
#+begin_src emacs-lisp
  (use-package diranged :ensure nil :after dired
    :load-path "~/src/github/tslight/diranged"
...
#+begin_src emacs-lisp
  (use-package lazygit :ensure nil
    :load-path "~/src/github/tslight/lazygit.el"
    :bind-keymap
    ("C-c g" . lazygit-map))
