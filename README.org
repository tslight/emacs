...
**** COMMENT Change completion styles
...
#+begin_src emacs-lisp :tangle (if (version< emacs-version "28") "no" init-file)
  (if (and (file-directory-p "~/oe-developers")
           (file-readable-p "~/oe-developers"))
...
After Emacs 29 we can use the standard ~*Completions*~ buffer and it's much
lighter, so only tangle on ~Emacs<29~.

#+begin_src emacs-lisp :tangle (if (version< emacs-version "29") init-file "no")
  (use-package corfu
    :custom
...
To get use vertico with code completions.
...
#+begin_src emacs-lisp
  (use-package orderless
    ...
    (setq completion-styles '(orderless flex partial-completion substring basic)
...
#+begin_src emacs-lisp
  (use-package default-text-scale :defer 7 :config (default-text-scale-mode))
#+end_src
  ...
  (use-package magit-repos :ensure nil
    ...
    (setq magit-repolist-columns
          '(("Name" 25 magit-repolist-column-ident nil)
            ...
            ("Pull" 5 magit-repolist-column-unpulled-from-upstream ((:right-align t) (:sort <)))
            ("Push" 5 magit-repolist-column-unpushed-to-upstream ((:right-align t) (:sort <)))
            ("Flag" 5 magit-repolist-column-flag ((:right-align t) (:sort <)))
