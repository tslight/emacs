...
#+begin_src emacs-lisp
  ...
  (use-package general :ensure :defer 1
    ...
    (mmap :prefix "SPC" :keymaps 'override
      "h" (general-simulate-key "C-h" :docstring "Simulate C-h with SPC h" :which-key "ctrl-h")
      "c" (general-simulate-key "C-c" :docstring "Simulate C-c with SPC c" :which-key "ctrl-c")
      "w" (general-simulate-key "C-w" :docstring "Simulate C-w with SPC w" :which-key "ctrl-w")
      ...
      "r"   #'ts-recentf-find-file
      "s"   #'save-buffer
      "S"   #'ts-save-buffers-silently
      ))
#+end_src
