...
#+begin_src emacs-lisp
  (use-package evil :ensure :defer 1
    ...
    (evil-define-key 'normal 'global (kbd "<leader>w") 'ts-save-buffers-silently)
    ...
    (evil-define-key 'normal 'global (kbd "<leader>l") 'ts-last-buffer)
    (evil-define-key 'normal 'global (kbd "<leader>n") 'next-buffer)
    (evil-define-key 'normal 'global (kbd "<leader>p") 'previous-buffer)
    (evil-define-key 'normal 'global (kbd "<leader>i") 'ts-indent-buffer)
